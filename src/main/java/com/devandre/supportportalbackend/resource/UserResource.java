...
import static com.devandre.supportportalbackend.constant.FileConstant.*;
...
public class UserResource extends ExceptionHandling {
    ...
    public ResponseEntity<User> addNewUser(@RequestParam("firstName") String firstName,
                                           ...
                                           @RequestParam(value = "profileImage", required = false) MultipartFile profileImage) throws UserNotFoundException, UsernameExistException, EmailExistException, MessagingException, IOException {
    ...
    public ResponseEntity<HttpResponse> deleteUser(@PathVariable("username") long username) throws IOException {

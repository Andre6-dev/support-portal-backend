package com.devandre.supportportalbackend.utility;
...
public class JWTTokenProvider {
    ...
    public boolean isTokenValid(String username, String token) {
        ...
        // El token es valido si es que no esta vacio el username y si el token no ha expirado
